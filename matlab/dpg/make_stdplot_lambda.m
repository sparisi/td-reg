...
%% 
folder_load = 'lambda_3_1/';
folder_load = 'lambda_3_1_noise/';
base_name = 'tdreg';
separator = '_';
hp1_list = {0, 0.1, 0.5, 0.9, 0.99, 0.999, 1, 1.001}; % hyperparameter lists
hp1_list = {0.5, 0.9, 0.99, 0.999, 1, 1.001}; % hyperparameter lists
filenames = {};
legendnames = {'\kappa = 0', '\kappa = 0.1', '\kappa = 0.5', '\kappa = 0.9', '\kappa = 0.99', '\kappa = 0.999', '\kappa = 1', '\kappa = 1.001'};
legendnames = {'\kappa = 0.5', '\kappa = 0.9', '\kappa = 0.99', '\kappa = 0.999', '\kappa = 1', '\kappa = 1.001'};
