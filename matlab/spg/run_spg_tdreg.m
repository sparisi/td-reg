...
%%
save(['./' folder_save '/spg_tdreg_' num2str(trial) '.mat'], 'H_history', 'KL_history', 'J_history', 'td_history', 'td_true_history', 'omega_history', 'theta_history', 'df_dtheta_history', 'dg_dtheta_history')
